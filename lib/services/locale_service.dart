...
class LocaleService {
  ...
  static const Map<String, String> _enStrings = {
    ...
    'task_name_too_long': 'Task name cannot exceed 40 characters',
    ...
    'subtask_name_too_long': 'Subtask name cannot exceed 40 characters',
    ...
    'week_4': 'W4',
    'week_5': 'W5',
    'no_stats_data': 'No task data for this period',
  ...
  static const Map<String, String> _zhStrings = {
    ...
    'task_name_too_long': '任务名称不能超过40个字符',
    'select_day': '选择日期',
    ...
    'subtask_name_too_long': '子任务名称不能超过40个字符',
    'subtasks_title': '子任务',
  ...
  static const Map<String, String> _jaStrings = {
    ...
    'task_name_too_long': 'タスク名は40文字以内で入力してください',
    'select_day': '日付を選択',
    ...
    'subtask_name_too_long': 'サブタスク名は40文字以内で入力してください',
    ...
    'week_4': '第4週',
    'week_5': '第5週',
    'no_stats_data': 'この期間のタスクデータはありません',
